...
public static void sapXepChuSo(int n) {
        ...
        for (int i = 0; i < dem0; i++) System.out.print("0 ");
        for (int i = 0; i < dem1; i++) System.out.print("1 ");
        for (int i = 0; i < dem2; i++) System.out.print("2 ");
        for (int i = 0; i < dem3; i++) System.out.print("3 ");
        for (int i = 0; i < dem4; i++) System.out.print("4 ");
        for (int i = 0; i < dem5; i++) System.out.print("5 ");
        for (int i = 0; i < dem6; i++) System.out.print("6 ");
        for (int i = 0; i < dem7; i++) System.out.print("7 ");
        for (int i = 0; i < dem8; i++) System.out.print("8 ");
        for (int i = 0; i < dem9; i++) System.out.print("9 ");
