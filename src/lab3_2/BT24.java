...
//nếu n nhỏ hơn 2 thì không phải là số nguyên tố
                ...
                int i =2;
do {
        //kiểm tra nếu có ước nào chia hết cho n và khác n thì n không phải số nguyên tố
if (n % i ==0 && i != n) {
                    System.out.println(n + " không phải là số nguyên tố");
            ...
            //kiểm tra nếu không tìm thấy ước số nào (i > căn bậc hai của n) thì n là số nguyên tố
