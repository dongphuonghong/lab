// 27. Một số hoàn thiện là số có tổng các ước số của nó (không kể nó) bằng chính nó. Nhập n và kiểm tra n có phải là số hoàn thiện không. Ví dụ: 6 là số hoàn thiện vì 1+2+3=6.
package lab3;
