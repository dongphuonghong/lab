// 16. Giải và biện luận phương trình: ax^2 + bx + c = 0
package lab2;
    ...
    public static void main(String[] args) {//
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            if (delta < 0) {
                ...
                // tính nghiệm x1 và x2 theo công thức x1 = (-b + căn bậc 2 của delta) / 2*a và
 ...
 * System.out.println("Nhap c: ");
 * c = sc.nextDouble();
 * //Xét các trường hợp của phương trình bậc 2 ax^2 + bx + c = 0 nếu a và b và c
 * đều bằng 0 thì phương trình có vô số nghiệm
 * if (a==0 && b==0) {
 * if (c==0) {
 ...
 * else {
 * //công thức tính x1 và x2 x1 =-b+delta*0.5/(2*a) và x2 = -b-delta*0.5/(2*a)
 * 0.5 là căn bậc 2 của delta
 * x1 =(-b+delta*0.5)/(2*a);
 * x2 = (-b-delta*0.5)/(2*a);
 * //in ra kết quả
