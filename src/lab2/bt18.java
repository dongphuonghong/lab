// 18. Viết chương trình nhập vào một số nguyên n gồm ba chữ số. Xuất ra màn hình chữ số lớn nhất và vị trí của nó. Ví dụ: n = 291 -> chữ số lớn nhất là 9 ở hàng chục.
package lab2;
 ...
 * //tìm vị trí của chữ số lớn nhất bằng cách tạo biến vị trí và gán giá trị mặc
 * định là trăm
 * String viTri = "trăm";
 ...
 * chuc = (n%100)/10;
 * donvi = n%10;
 * //tìm số lớn nhất và vị trí của số lớn nhất bằng cách tạo biến max và
 * ketquavitri để lưu giá trị và vị trí của số lớn nhất măc định là số hàng trăm
 * int max = tram;
 * String ketquavitri="Tram";
 * //nếu số hàng đơn vị lớn hơn số lớn nhất thì gán số lớn nhất bằng số hàng đơn
 * vị và vị trí là đơn vị
 * if (donvi > max) {
 * max = donvi;
 * ketquavitri = "Don vi";
 * }
 * //nếu số hàng chục lớn hơn số lớn nhất thì gán số lớn nhất bằng số hàng chục
 * và vị trí là chục
 * if (chuc > max) {
 * max = chuc;
 * ketquavitri = "Chuc";
