/**
 * 19. Viết chương trình nhập vào số nguyên n gồm ba chữ số. Xuất ra màn hình theo thứ tự tăng dần của các chữ số. Ví dụ: n = 291 -> xuất ra 129
 */
package lab2;
...
public class Bt19 {
    public static void main(String[] args) {
        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            // hàng đơn vị = n%10
            donvi = n % 10;
            // sắp xếp các chữ số theo thứ tự tăng dần bằng cách sử dụng hàm math.max và
            // math.mincủa thư viện java
 ...
 * //hàng đơn vị = n%10
 * donvi = n%10;
 * //sắp xếp các chữ số theo thứ tự tăng dần cách so sánh 2 số đầu tiên, sau đó
 * so sánh số lớn nhất với số cuối cùng bằng cách sử dụng toán tử 3 ngôi
