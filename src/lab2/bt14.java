// 14. Cho ba số a, b, c đọc vào từ bàn phím. Hãy in ra màn hình theo thứ tự tăng dần các số.
package lab2;
 ...
 * System.out.println("Nhap c");
 * c = sc.nextInt();
 * //sắp xếp 3 số a,b,c theo thứ tự tăng dần bằng cách sử dụng hàm Math.max và
 * Math.min
 ...
 * c = sc.nextInt();
 * //Sắp xếp 3 số a,b,c theo thứ tự tăng dần bằng cách so sánh 2 số đầu tiên,
 * sau đó so sánh số lớn nhất với số còn lại bằng cách sử dụng toán tử 3 ngôi
 * int max=(a>b)?a:b;
 * max=(max>c)?max:c;
 * int min=(a<b)?a:b;
 * min=(min<c)?min:c;
...
/**
 * //Cho ba sô a, b, c đoc vao tư ban phim. Hay in ra man hinh theo thư tư tăng
 * dân cac sô.
 * import java.util.Scanner;
 * public class Bt14edit {
 * public static void main(String[] args) {
