...
//nếu delta > 0 thì phương trình có 2 nghiệm phân biệt x1 và x2
        ...
        //tính x1 và x2 bằng công thức x1 = (-b + căn delta)/(2*a) và x2 = (-b - căn delta)/(2*a)
...
public class bt17edit {
    public static void main(String[] args) {
        ...
        if(delta < 0){
            ...
            //công thức tính x1, x2 x1=(-b+delta*0.5)/(2*a) và x2 = (-b-delta*0.5)/(2*a) 0.5 = căn bậc 2 của delta
            x1 =(-b+delta*0.5)/(2*a);
            x2 = (-b-delta*0.5)/(2*a);
            //in ra kết quả
            System.out.println("Phuong trinh co 2 nghiem phan biet x1 = " + x1 + " va x2 = " + x2);
